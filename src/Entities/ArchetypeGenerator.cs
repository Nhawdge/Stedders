...
namespace Stedders.Entities
{
    public static class ArchetypeGenerator
    {
        public static Entity GeneratePlayerMech(GameEngine engine)
        {
            ...
            var legs = new Sprite(engine.TextureManager.GetTexture(TextureKey.Mech2), "Assets/Art/Mech2", 3, true) { MechPiece = MechPieces.Legs, CanRotate = false, ZIndex = 3 };
        ...
        public static Entity GenerateEnemy(GameEngine engine, Vector2 position)
        {
            ...
            var sprite = new Sprite(engine.TextureManager.GetTexture(TextureKey.Enemy1), "Assets/Art/Enemy1", 3, true)
            {
                ZIndex = 1,
                CanRotate = false,
                Position = position
        ...
        public static Entity GeneratePlant(GameEngine engine, Vector2 position)
        {
            ...
            plant.Components.Add(new Sprite(engine.TextureManager.GetTexture(TextureKey.Plant1), "Assets/Art/Plant1", 3, false)
            {
                Position = position
            });
        ...
        {
            var barn = new Entity();
            var sprite = new Sprite(engine.TextureManager.GetTexture(TextureKey.Barn), "Assets/Art/Barn", 3, true) { Position = position };
        ...
        public static Entity GenerateSilo(GameEngine engine, Vector2 position)
        {
            ...
            silo.Components.Add(new Sprite(engine.TextureManager.GetTexture(TextureKey.Silo), "Assets/Art/Silo", 3, true) { Position = position });
            return silo;
        }
        ...
        internal static Entity GenerateField(GameEngine engine, Vector2 position, bool startWithPlant = false)
        {
            ...
            var sprite = new Sprite(engine.TextureManager.GetTexture(TextureKey.Field1), "Assets/Art/Field1", 3, false) { Position = position };
            ...
            if (startWithPlant)
            {
                ...
                field.Components.Add(new Sprite(engine.TextureManager.GetTexture(TextureKey.Plant1), "Assets/Art/Plant1", 3, false)
                {
                    Position = position
                });
            }
